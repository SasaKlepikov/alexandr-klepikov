            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php
                        $links = Page::getActiveOtherPages();
                        if (count($links) >= 1) {
                          ?>
                          <li class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                  <?php foreach ($links as $link) { ?>
                                    ...
                                    if (function_exists('iconv')) {
                                      $linkURL = iconv('utf-8', 'us-ascii//TRANSLIT', $linkURL);
                                    }
                          ...
                          <li class="dropdown">
                              ...
                              <ul class="dropdown-menu dropdown-menu-language">
                                  ...
                                  foreach ($all_langs as $code => $info) {
                                    ...
                                    ?>
                                    <li>
                                        <a href="?<?php echo urlencode($_GET['QUERY_STRING']); ?>&amp;lang=<?php echo $code; ?>" style="text-transform: uppercase;" title="<?php echo Internationalization::getLanguageDescription($code); ?>"><img width="24px" height="24px" src="<?php echo ROOT_PATH; ?>ext_images/flags/<?php echo $lang; ?>.png">&nbsp;<?php echo Internationalization::getLanguageDescription($code); ?></a>
                                    </li>
                                  <?php } ?>
                              </ul>
                          </li>
