...
<?php the_post(); ?>
	...
	<div id="primary" class="site-content">
		...
		<div id="content" role="main">
			...
			<?php set_layout( 'pages', true, 'sidebar-right' ); ?>
			...
			<?php set_layout( 'pages', false, 'sidebar-right' ); ?>
			<?php
			// Primary property-type sidebar.
			if ( isset( $post->property_type ) && is_active_sidebar( "wpp_sidebar_" . $post->property_type ) ) : ?>

				<aside id="primary" class="<?php wpp_css( 'property::primary', "widget-area wpp_sidebar_{$post->property_type}" ); ?> sidebar medium-3 small-12 columns" role="complementary">
