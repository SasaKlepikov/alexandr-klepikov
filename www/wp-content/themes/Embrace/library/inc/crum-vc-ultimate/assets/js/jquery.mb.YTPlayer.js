...
jQuery(window).load(function(){
    jQuery('.upb_video_class .utube').each(function(index, element){
        ...
        var options = { videoURL: uvdo, ratio: '16/9', quality:'hd720', showControls:false, containment:selector, startAt: ustart, mute:umuted,loop:uloop, stopAt:ustop, optimizeDisplay:true };
