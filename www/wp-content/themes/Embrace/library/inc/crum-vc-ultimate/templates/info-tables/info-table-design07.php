...
if(class_exists("Ultimate_Info_Table")){
    class Info_Design07 extends Ultimate_Info_Table{
        public static function generate_design($atts,$content = null){
            ...
            if (!($heading_color == '')) {
                ...
                $darker_heading_color_1 = 'style="background-color: ' . $heading_color . ' ; box-shadow:inset 0 5px 5px '.$darker_heading_color.';';
            ...
            $output .= '<div class="ult_pricing_table_wrap ult_info_table '.$animate.' ult_design_7 '.$featured.' " '.$animation_data.'>';
            ...
            $output .= '</div><!--ult_pricing_heading-->';
                ...
                $output .= '<div class="ult_price_body_block" ' . $darker_heading_color_1 . '">
                                    <div class="additional-square" style="' . $darker_heading_color_2 . '"></div>
