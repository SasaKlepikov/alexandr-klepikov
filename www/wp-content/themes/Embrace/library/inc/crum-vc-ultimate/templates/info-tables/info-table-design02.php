...
if(class_exists("Ultimate_Info_Table")){
    class Info_Design02 extends Ultimate_Info_Table{
        public static function generate_design($atts,$content = null){
            ...
            if (!($heading_color == '')) {
               $color_style = 'style="background-color: '.$heading_color.'"';
            }else{
                $color_style = '';
            }

            $output .= '<div class="ult_pricing_table_wrap ult_info_table '.$animate.' ult_design_2 '.$featured.' " '.$animation_data.'>';
            ...
            $output .= '<div class="ult_price_body_block" '.$color_style.' >
