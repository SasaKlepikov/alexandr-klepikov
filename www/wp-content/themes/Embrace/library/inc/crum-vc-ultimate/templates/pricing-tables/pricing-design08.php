...
if(class_exists("Ultimate_Pricing_Table")){
    class Pricing_Design08 extends Ultimate_Pricing_Table{
        public static function generate_design($atts,$content = null){
            ...
            $output .= '<div class="ult_pricing_table_wrap '.$animate.' ult_design_8 '.$featured.' '.$recommended.' ult-cs-'.$color_scheme.'" '.$animation_data.'>';
