...
if(class_exists("Ultimate_Pricing_Table")){
	class Pricing_Design01 extends Ultimate_Pricing_Table{
		public static function generate_design($atts,$content = null){
			...
			$output .= '<div class="ult_pricing_table_wrap '.$animate.' ult_design_1 '.$featured.' '.$recommended.' ult-cs-'.$color_scheme.'" '.$animation_data.'>';
            ...
            $output .= '<div class="ult_pricing_table" style="'.$featured_style.'">';
				...
				$output .= '<div class="ult_price_body_block" >
								<div class="ult_price_body">
									<div class="ult_price">
										<span class="ult_price_figure" style="color:'.$heading_color.'">'.$package_price.'</span>
										<span class="ult_price_term" style="color:'.$heading_color.'">'.$package_unit.'</span>
									</div>
								</div>
