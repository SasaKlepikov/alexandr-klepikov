...
* Template : Design layout 09
*/
if(class_exists("Ultimate_Pricing_Table")){
    class Pricing_Design09 extends Ultimate_Pricing_Table{
        public static function generate_design($atts,$content = null){
            ...
            if (!($heading_color == '')) {
	            ...
	            $body_style ='style="background-color: '.$heading_color.'; box-shadow:5px 0 0 0 '.$heading_color.', -5px 0 0 0 '.$heading_color.';"';
            ...
            $output .= '<div class="ult_pricing_table_wrap '.$animate.' ult_design_9 '.$featured.' '.$recommended.' ult-cs-'.$color_scheme.'" '.$animation_data.'>';
