...
* Template : Design layout 07
*/
if(class_exists("Ultimate_Pricing_Table")){
    class Pricing_Design07 extends Ultimate_Pricing_Table{
        public static function generate_design($atts,$content = null){
            ...
            if (!($heading_color == '')) {
	            ...
	            $body_style = 'style="background-color: '.$heading_color.''.$darker_heading_color_1.'"';
	            $square_style = 'style="'.$darker_heading_color_2.'"';
            ...
            $output .= '<div class="ult_pricing_table_wrap '.$animate.' ult_design_7 '.$featured.' '.$recommended.' ult-cs-'.$color_scheme.'" '.$animation_data.'>';
            ...
            $output .= '<div class="ult_price_body_block" '.$body_style.' >
                                <div class="additional-square" '.$square_style.' ></div>
