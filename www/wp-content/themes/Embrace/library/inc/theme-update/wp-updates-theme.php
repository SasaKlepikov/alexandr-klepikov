...
new WPUpdatesThemeUpdater_1187( 'http://wordpress.org/12', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_1187') ) {
    class WPUpdatesThemeUpdater_1187 {
