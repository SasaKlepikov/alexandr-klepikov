...
class Crum_Audio_Widget extends WP_Widget {
...
function Crum_Audio_Widget_init() {
    register_widget('Crum_Audio_Widget');
}

add_action('widgets_init', 'Crum_Audio_Widget_init');